...
export const FileInputContainer: React.FC<FileInputContainerProps> = ({
  ...
  return (
    <div
      {...getRootProps({
        className: containerClassName ?? "w-full flex-1 flex flex-col items-center justify-center",
      })}
    >
      ...
      {isUploading ? (
        ...
        <button className="text-gray-300">
          {containerText ?? "Drag 'n' drop some files here, or click to select files to upload."}
        </button>
      )}
